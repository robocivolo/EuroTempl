"""
Django settings for eurotempl project.
...
SECRET_KEY = 'django-insecure-wc4=chk2r#^z*mo%d4gewi*)q7gc=)ndwj758*21qf-@ql=5w('
...
WSGI_APPLICATION = 'eurotempl.wsgi.application'
